...
const initialState = [
  {
    ...
    inputs: [
      ...
      { inputNumber: 4, name: "Color ", value: "#4f4f4f", type: "color" },
    ],
  },
];
...
export const shadowSlice = createSlice({
  ...
  reducers: {
    removeShadow: (state, action) => {
      ...
      //state.filter((id) => state.id !== action.payload.id);
    ...
    addShadow: (state, action) => {
      state.push({
        ...
        inputs: [
          ...
          { inputNumber: 5, name: "Color ", value: "#4f4f4f", type: "color" },
        ],
      });
    },
...
export const { removeShadow, updateCheckbox, updateShadowValue, addShadow } =
  shadowSlice.actions;
